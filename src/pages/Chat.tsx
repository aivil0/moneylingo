      ...
      <div className="relative z-20">
        <div className="px-4 py-4 container mx-auto max-w-4xl">
          <div className="flex items-center gap-2 glass-card p-2 rounded-3xl shadow-xl">
            <Input placeholder={t("chat.placeholder")} value={message} onChange={e => setMessage(e.target.value)} onKeyPress={handleKeyPress} className="h-12 text-base rounded-3xl bg-transparent border-0 focus-visible:ring-0 focus-visible:ring-offset-0 pr-12" aria-label="Message input" />
